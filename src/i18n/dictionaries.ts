...
const dictionaries = {
  ko: {
    ...
    searchResults: "검색 결과",
    editUser: "정보 수정",
    updateAccount: "사용자 정보 저장",
    updatingAccount: "저장 중...",
    backToUsers: "사용자 목록",
    grade: "직급",
    jobTitle: "직책",
    mobilePhone: "휴대전화",
  ...
  en: {
    ...
    searchUsers: "Search employee no., name, or email",
    allRoles: "All roles",
    ...
    updateAccount: "Save user details",
    updatingAccount: "Saving...",
